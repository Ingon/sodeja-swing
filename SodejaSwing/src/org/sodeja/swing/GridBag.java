...
public class GridBag {
    ...
    // Common methods
    public static GridBagConstraints create(int gridx, int gridy, int gridwidth, int gridheight, 
            double weightx, double weighty) {
        return create(gridx, gridy, gridwidth, gridheight, 
                weightx, weighty, DEFAULT_ANCHOR, DEFAULT_FILL);
    }

    public static GridBagConstraints create(int gridx, int gridy, int gridwidth, int gridheight, 
            double weightx, double weighty, int anchor, int fill) {
        return create(gridx, gridy, gridwidth, gridheight, 
                weightx, weighty, anchor, fill, DEFAULT_INSETS);
    }
    
    private static GridBagConstraints create(int gridx, int gridy, int gridwidth, int gridheight, 
            double weightx, double weighty, int anchor, int fill, Insets insets) {
        return create(gridx, gridy, gridwidth, gridheight, 
                weightx, weighty, anchor, fill, insets, DEFAULT_IPADX, DEFAULT_IPADY);
    }
    ...
    public static GridBagConstraints lineField(int gridy, int gridWidth) {
        return create(1, gridy, gridWidth, 1, 1.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL);
    }
    ...
    private static GridBagConstraints line(int gridx, int gridy, double weightx) {
        return create(gridx, gridy, 1, 1, weightx, 0.0, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL);
    }
